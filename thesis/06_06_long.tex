\section{Simulating Longer Propagation Distances}
  ...
  \subsection{Propagation in the Coupling Pulse Scheme}
    ...
    frequencies $\Omega(z, \tau)$ and (bottom) pulse areas $\theta(z)$. The red
    dotted line gives the combined pulse area $\theta = \sqrt{\theta_p^2 +
    \theta_c^2}$.
    }
  ...
  \subsection{Hyperfine Structure \& Degeneracy}
    ...
    vector $z$), the orthogonal beam is defined by a polarisation vector $x$
